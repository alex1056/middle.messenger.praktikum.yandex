        ...
        form(class="login-form" id="form-registr")
            div(class="login-form__cont")
                ...
                div(class="login-form__fset")
                    ...
                    input(type="email" name="email" id="email-form-registr" class="login-form__input" value="" placeholder="Почта")/
                ...
                div(class="login-form__fset")
                    ...
                    input(type="text" name="login" id="login-form-registr" class="login-form__input" value="" placeholder="Логин")/
                div(class="login-form__err-message")
                ...
                div(class="login-form__fset")
                    ...
                    input(type="text" name="first_name" id="name-form-registr" class="login-form__input" value="" placeholder="Имя")/
                div(class="login-form__err-message")
                ...
                div(class="login-form__fset")
                    ...
                    input(type="text" name="second_name" id="surname-form-registr" class="login-form__input" value="" placeholder="Фамилия")/
                div(class="login-form__err-message")
                ...
                div(class="login-form__fset")
                    ...
                    input(type="phone" name="phone" id="phone-form-registr" class="login-form__input" value="" placeholder="Телефон")/
                div(class="login-form__err-message")
                ...
                div(class="login-form__btn-cont")
                    != buttonsubmit
                    a(class="btn login-form__btn login-form__btn_white" id="registr-btn-redirect-login-form")
