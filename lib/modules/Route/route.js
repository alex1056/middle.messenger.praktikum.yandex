  ...
  _createClass(Route, [{
    ...
    value: function match(pathname) {
      ...
      if (pattern === this._pathname) {
        ...
        var isRoute = pathname.match(routeMatcher); // isRoute - результат распознавания pathname по шаблону pattern
    ...
    value: function render() {
      ...
      if (nodeToRemove) {
        ...
        var _node = this._block.getContent(); // console.log('node', node);
